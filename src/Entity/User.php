...
class User implements UserInterface
{
    ...
    public function getNumeroProducteur(): ?string
    {
        return $this->numeroProducteur;
    }

    public function setNumeroProducteur(?string $numeroProducteur): self
    {
